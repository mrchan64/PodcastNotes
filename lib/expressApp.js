...
app.get('/', (req, res) =>{
  ...
  if(req.query.url == "http://podcast-media.ucsd.edu/Podcasts/wi18/bieb130_a00/bieb130_a00_wi18-02152018-1100.mp4"){
    exports.wscallback('demotime2.txt','demoresult2.txt', passthrough);
  } 
  if(req.query.url == "http://podcast-media.ucsd.edu/Podcasts/wi18/usp143_a00/usp143_a00_wi18-03132018-0930.mp4"){
    exports.wscallback('demotime3.txt','demoresult3.txt', passthrough);
  } 
